...
class CoreMod(loader.Module):
    ...
    strings = {
        ...
        "acbot": (
            ...
            " <b>Author-TL: </b><i>{}</i>\n\n<emoji"
            " ⌨</emoji> <b>Developer:"
            " t.me/AuthorChe t.me/Yadym_Yem</b>"
        ),
        "check_url": (
    ...
    @loader.command(ru_doc="Показать версию AuthorBot")
    async def authorcmd(self, message: Message):
        """Get AuthorBot version"""
        await utils.answer(
            message,
    ...
    async def dllangpackcmd(self, message: Message):
        """[link to a langpack | empty to remove] - Change AuthorBot translate pack (external)
        """
        args = utils.get_args_raw(message)
