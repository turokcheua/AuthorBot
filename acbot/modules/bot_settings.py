...
class acbotSettingsMod(loader.Module):
    ...
    strings = {
        ...
        "inline_settings": "⚙️ <b>Here you can configure your  settings</b>",
        "confirm_update": (
        ...
        "nonick_warning": (
            ...
            "You may get muted in  chats. Change prefix or "
            "disable NoNick!"
        ),
        "reply_required": (
        ...
        "deauth_confirm": (
            "⚠️ <b>This action will fully remove  from this account and can't be"
            " reverted!</b>\n\n<i>-  chats will be removed\n- Session will be"
            " terminated and removed\n-  inline bot will be removed</i>"
        ),
    ...
    async def _uninstall(self, call: InlineCall):
        ...
        if any(folder.title == "AuthorBot" for folder in folders):
            folder_id = max(
                folders,
                key=lambda x: x.id,
            ).id
